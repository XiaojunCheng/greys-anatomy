...
public abstract class ReflectAdviceTracingListenerAdapter extends ReflectAdviceListenerAdapter
    ...
    @Override
    final public void invokeBeforeTracing(Integer tracingLineNumber, String tracingClassName, String tracingMethodName,
                                          String tracingMethodDesc) throws Throwable {

        // 如果before()方法尚未被调用
        // 为 #78 问题所触发的情况
        if (!isBeforeCalledRef.get()) {
            skipSuperInitStackRef.get()
                    .push(new Tracing(tracingLineNumber, tracingClassName, tracingMethodName, tracingMethodDesc));
            return;
        }
    ...
    private void popSuperInit() throws Throwable {
        ...
        if (!stack.isEmpty()) {
            ...
            tracingInvokeBefore(tracing.tracingLineNumber, tracing.tracingClassName, tracing.tracingMethodName,
    ...
    @Override
    final public void invokeThrowTracing(Integer tracingLineNumber, String tracingClassName, String tracingMethodName,
                                         String tracingMethodDesc, String throwException) throws Throwable {
        popSuperInit();
        tracingInvokeThrowing(tracingLineNumber, tracingClassName, tracingMethodName, tracingMethodDesc,
                throwException);
    }

    @Override
    final public void invokeAfterTracing(Integer tracingLineNumber, String tracingClassName, String tracingMethodName,
                                         String tracingMethodDesc) throws Throwable {
        popSuperInit();
        tracingInvokeAfter(tracingLineNumber, tracingClassName, tracingMethodName, tracingMethodDesc);
    }

    public void tracingInvokeBefore(Integer tracingLineNumber, String tracingClassName, String tracingMethodName,
                                    String tracingMethodDesc) throws Throwable {

    }

    public void tracingInvokeAfter(Integer tracingLineNumber, String tracingClassName, String tracingMethodName,
                                   String tracingMethodDesc) throws Throwable {

    }

    public void tracingInvokeThrowing(Integer tracingLineNumber, String tracingClassName, String tracingMethodName,
                                      String tracingMethodDesc, String throwException) throws Throwable {
    }
    ...
    static class Tracing {
        ...
        Tracing(Integer tracingLineNumber, String tracingClassName, String tracingMethodName,
